...
////
  fetch(URL)
    ...
    <td><div class="bloquecart"><input type="number" id="inputCarrito" min="0" value="1" class="cant" onchange="recalcular();"></td>
    <td id="ress">${productocompra.articles[0].currency} <span class="res">${productocompra.articles[0].unitCost}</span></td></div></tr>
    </div> `
    ...
    <td><div class="bloquecart"><input type="number" id="inputCarrito" min="0" value="1" class="cant" onchange="recalcular()"></td>
    <td id="ress">${el.currency} <span class="res">${el.cost}</span></td></tr></div><br/>`;
      })
